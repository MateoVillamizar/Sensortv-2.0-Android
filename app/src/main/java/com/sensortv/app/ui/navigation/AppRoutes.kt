 ...
 *
 * Centraliza las rutas para facilitar el mantenimiento y refactorización.
 *
 * Se utiliza sealed class en lugar de enum para permitir futura extensión con rutas dinámicas si el proyecto crece.
 */
